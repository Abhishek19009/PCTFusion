...
if __name__ == '__main__':
    ...
    sets = [13, 14, 15, 16, 17, 18, 19, 20, 21]
    ...
    for cur_set in sets:
        ...
        # Initialize datasets
        training_dataset = SemanticKittiDataset(config, cur_set, set='training',
                                                balance_classes=True)
        test_dataset = SemanticKittiDataset(config, cur_set, set='test',
...
#         chosen_chkp = './important_checkpoints/Log_2022-10-04_13-00-20/checkpoints/current_chkp.tar'
    #     chosen_chkp = './results/Log_2022-10-05_08-34-18/checkpoints/current_chkp.tar'
        chosen_chkp = None
    ...
    #     trainer.train(net, training_loader, test_loader, config)
        tester.slam_segmentation_test(net, test_loader, config, num_votes=50)
