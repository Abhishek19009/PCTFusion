...
class SemanticKittiDataset(PointCloudDataset):
    ...
    def __init__(self, config, cur_set, set='training', balance_classes=True):
        ...
        # Dataset folder
        self.path = '/DATA/abhishek/SemanticKitti/unzipped/dataset'
...
#             self.sequences = ['{:02d}'.format(i) for i in range(11, 22)]
            self.sequences = ['{:02d}'.format(cur_set)]
#             self.sequences = ['{:02d}'.format(i) for i in range(11, 14)]
        else:
